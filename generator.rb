...
class DummyDataGenerator
  ...
  def initialize
    ...
    @surnames = {
      'Apellido1' => ['García', 'Rodríguez', 'Martínez', 'Hernández'],
      'Apellido2' => ['Smith', 'Johnson', 'Williams', 'Brown']
    }
  ...
  def build_ui
    ...
    TkLabel.new(root) { text 'Número de registros:' }.pack
    @num_records_entry = TkEntry.new(root).pack
